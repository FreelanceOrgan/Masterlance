...
const {getAllUsers, getUserById, addUser, updateUser, updateUserRole, upsertVerificationImage, upsertVerificationStatus, blockUser, changeEmail, changePassword, deleteUser} = require("../Controllers/userController");
...
router.route("/:id/verify/image")
    .patch(authentication, authorization(ModelNames.Users), checkParamIdEqualTokenId("id"), updateUserValidation, upsertVerificationImage);
